        ...
        >
          ...
          <div css={inner}>
            ...
            <br/>
              ...
              <br/>
              <br/>
              <SiteFeatured>{"as seen on"}</SiteFeatured>
                  <img
                    style={{ maxHeight: '75px' }}
                    src={props.data.featured.childImageSharp.fixed.src}
...
export const pageQuery = graphql`
  query blogPageQuery($skip: Int!, $limit: Int!) {
    ...
    header: file(relativePath: { eq: "img/maincover.jpg" }) {
      childImageSharp {
        # Specify the image processing specifications right in the query.
        # Makes it trivial to update as your page's design changes.
        fluid(maxWidth: 2000) {
    ...
    featured: file(relativePath: {eq: "img/featured.png"}) {
        childImageSharp {
          # Specify the image processing specifications right in the query.
          # Makes it trivial to update as your page's design changes.
          fixed {
